...
export default function ReturnsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 lg:py-16">
      <h1 className="text-3xl font-bold text-center mb-12">返品・交換について</h1>

      <div className="prose prose-gray max-w-none space-y-8">
        <section>
          <h2 className="text-xl font-bold mb-4">返品・交換の条件</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">返品・交換ができない場合</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">不良品・誤送の場合</h2>
          <p className="text-gray-600">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">正規品保証</h2>
          <p className="text-gray-600">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">返金について</h2>
          <p className="text-gray-600">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">返品・交換の手順</h2>
