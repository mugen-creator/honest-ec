...
export function ShareButtons({ productName, productId }: ShareButtonsProps) {
  ...
  const shareText = `${productName} | Honest-Maison`;
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={shareToLine}
        className="w-8 h-8 flex items-center justify-center rounded-full bg-[#00B900] text-white hover:bg-[#00a000] transition-colors"
        aria-label="LINEでシェア"
      >
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
